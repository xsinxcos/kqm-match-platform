package com.chaos.comment.service.impl;
...
import com.chaos.comment.domain.vo.CommentVo;
import com.chaos.comment.domain.vo.ShowChildCommentVo;
import com.chaos.comment.mapper.CommentMapper;
...
public class CommentServiceImpl extends ServiceImpl<CommentMapper, Comment> implements CommentService {
    ...
    public ResponseResult listCommentByPostId(Long postId, Integer pageNum, Integer pageSize) {
        ...
        //feign调用获取用户信息
        Map<Long, AuthUserBo> map = userFeignClient.getBatchUserByUserIds(ids).getData();
        //封装进VO
        List<CommentVo> commentVos = new ArrayList<>();
        for (Comment record : page.getRecords()) {
            AuthUserBo user = map.get(record.getCreateBy());
