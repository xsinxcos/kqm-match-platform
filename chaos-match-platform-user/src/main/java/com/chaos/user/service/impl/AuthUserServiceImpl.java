package com.chaos.user.service.impl;
...
import com.chaos.user.domain.vo.app.GetUserInfoByIdVo;
...
import com.chaos.user.domain.vo.UserInfoVo;
import com.chaos.user.domain.vo.admin.UserListVo;
...
public class AuthUserServiceImpl extends ServiceImpl<AuthUserMapper, AuthUser> implements AuthUserService {
    ...
    public ResponseResult getUserInfoById(Long userId) {
        AuthUser user = getById(userId);
        GetUserInfoByIdVo vo = BeanCopyUtils.copyBean(user, GetUserInfoByIdVo.class);
        return ResponseResult.okResult(vo);
    }
